    ...
    <PageLayout mode={mode} toggleMode={toggleMode}>
      <Container maxWidth="lg" sx={{ py: 4 }}>
        ...
        <Typography variant="subtitle1" sx={{ color: 'text.secondary', mb: 3 }}>
          A React + MUI frontend for exploring option chains, tracking
          positions, and analyzing risk. Backend services are powered by
          Python/FastAPI for data ingestion and calculations.
        </Typography>
        ...
        <Card sx={{ mb: 4 }}>
          ...
          <CardContent>
            <Typography variant="body1" sx={{ mb: 2 }}>
              The platform focuses on fast quoting and clear portfolio insights.
              It provides a clean UI for chains, greeks, and P/L, with
              responsive layouts and accessible components using MUI.
            </Typography>
            ...
            <Card>
              ...
              <CardContent>
                ...
                <Typography variant="body2" color="text.secondary">
                  Filter by expiration and strike, surface greeks, and compare
                  calls vs. puts quickly. Built with reusable data grids and MUI
                  components for clean interaction.
                </Typography>
              </CardContent>
            </Card>
          </Grid>
          ...
          <Grid item xs={12} md={6}>
            <Card>
              ...
              <CardContent>
                ...
                <Typography variant="body2" color="text.secondary">
                  Track open positions, delta exposure, and running P/L. Visual
                  components emphasize readable metrics and responsive layouts
                  across devices.
                </Typography>
              </CardContent>
            </Card>
