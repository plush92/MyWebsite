        ...
        <Typography variant="subtitle1" sx={{ color: "text.secondary", mb: 3 }}>
          ...
          <CardContent>
            <Typography variant="body1" sx={{ mb: 2 }}>
              This personal project is a nostalgia‑inspired 2D RPG where you explore small
              scenes, interact with objects, and trigger scripted moments. I focused on
              clean state handling, scene transitions, collision, and lightweight cutscenes.
            </Typography>
            ...
            <Card>
              ...
              <CardContent>
                ...
                <Typography variant="body2" color="text.secondary">
                  Objects and NPCs trigger prompts and simple scripted events. UI hints
                  guide the player to explore without heavy UI chrome.
                </Typography>
              </CardContent>
            </Card>
          </Grid>
          <Grid item xs={12} md={6}>
            <Card>
              ...
              <CardContent>
                ...
                <Typography variant="body2" color="text.secondary">
                  Quick playtesting and feedback shaped the feel—short scenes, readable
                  prompts, and smooth transitions keep it approachable.
                </Typography>
              </CardContent>
            </Card>
          </Grid>
