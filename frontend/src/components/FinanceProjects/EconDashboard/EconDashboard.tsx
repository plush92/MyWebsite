  ...
  return (
    <Box maxWidth="md" mx="auto" mt={4} component={Paper} p={4} elevation={3}>
      ...
      <Typography variant="body1" mb={3}>
        The Econ Dashboard provides an overview of key economic metrics that
        impact financial markets, businesses, and consumer behavior. These
        metrics are carefully chosen to give a comprehensive understanding of
        the economic landscape, enabling better decision-making and insights.
      </Typography>
      <Typography variant="h5" fontWeight="bold" gutterBottom>
        Purpose
      </Typography>
      <Typography variant="body1" mb={3}>
        This dashboard serves as an educational tool, helping users understand
        the interconnectedness of economic indicators and their implications on
        various sectors. Each metric is explained in context to ensure clarity
      ...
      <Typography variant="body1">
        Use the sidebar to navigate through each category for detailed
